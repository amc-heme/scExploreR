...
dge_test_selection_server <- function(id,
  ...
  moduleServer(id,
               function(input,output,session){
                 ...
                 #Reactive below avoids namespace collision issue while pointing 
                 #group by selections to one variable
                 ...
                 #Slected marker classes: process input if marker identification 
                 #is the mode selected

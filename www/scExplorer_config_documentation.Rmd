...
![](Screenshots/config_documentation/001-Label%20and%20description.png)
...
![](Screenshots/config_documentation/003-Add-Remove-assays.gif){width="690"}
...
![](Screenshots/config_documentation/004-Assay-options.png)
...
![](Screenshots/config_documentation/005-Metadata-Include-Exclude.gif){width="690"}
...
![](Screenshots/config_documentation/006-Metadata-Groups-Interface.png){width="371"}
...
![](Screenshots/config_documentation/007-Enable-ADT-Threshold.gif){width="690"}
...
![](Screenshots/config_documentation/008-Add-ADT-Threshold.gif){width="690"}
...
![](Screenshots/config_documentation/009-Edit-ADT-Threshold.gif){width="690"}

![](Screenshots/config_documentation/010-Delete-ADT-Threshold.gif){width="690"}

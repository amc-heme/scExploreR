...
The Average Expression column is only returned for Seurat and BPCells-backed Seurat objects. It is not present in DGE results for anndata objects. See the [object guidelines](object_guidelines.html) for more details on feature availability by object class.
:::

...
When plot types based on a gene or multiple genes are selected, the feature entry menu will display beneath the switches. Any gene in the dataset may be entered here. Surface proteins, gene signatures, and other data enabled by the user setting up the browser may also be entered in this menu. As you type the name of a feature, suggestions will appear along with the type of the suggested feature.
...
### Advanced (String) Subsetting {#advanced-string-subsetting}
...
### Choose Projection {#DimPlots-choose-projection}
...
### Choose Number of Columns {#DimPlots-choose-number-of-columns}
...
### Label Groups {#DimPlots-label-groups}
...
### Choose Projection {feature-plots-choose-projection}
...
### Display Options for Legend Title {#feature-plots-display-legend-title}
...
### Choose Number of Columns {#feature-plots-choose-number-of-columns}
...
### Display Feature Name Above Panels {#feature-plots-display-name}
...
### Order Cells by Expression {#feature-plots-order-cells}
...
### Label Groups {#feature-plots-label-groups}
...
### Metadata for Primary Groups {#violin-plots-metadata-for-primary-groups}
...
### Metadata for Secondary Grouping {#violin-plots-metadata-for-secondary-grouping}
...
### Order of Groups on Plot {#violin-plots-order-of-groups}
...
### Number of Columns {#violin-plots-number-of-columns}
...
### Metadata to group by {#dot-plots-metatdata-group-by}
...
### Order of Groups on Plot {#dot-plots-order-of-groups}
...
### Manually Adjust Plot Dimensions {#dot-plots-manually-adjust-plot-dimensions}
...
### Use Separate Features for Dot Plot {#dot-plots-use-separate-features}
...
### Feature for x-axis {#scatterplots-feature-for-x-axis}
...
### Feature for y-axis {#scatterplots-feature-for-y-axis}
...
### Metadata to Group By {#scatterplots-metadata-group-by}
...
### Show Pearson Coefficient (#scatterplots-show-pearson-coefficient)
...
### Metadata to Group by {ridge-plots-metadata-group-by}
...
### Define Custom X-axis Limits {#ridge-plots-define-custom-x-axis-limits}
...
### Choose Metadata for Proportions {#cell-proportion-plot-choose-metadata- proportions}
...
### Choose Metadata for Proportion Comparison {#cell-proportion-plot-choose-metadata-proportion-comparison}
...
### Order of Groups on Plot {#cell-proportion-plot-order-groups}
...
### View Number of Patients by Menu {#metadata-pie-chart-number-of-patients-by-menu}
...
### Title Options {#metadata-pie-chart-title-options}
...
# Differential Gene Expression Tab {#differential-expression-tab}
...
### Choose classes to include in marker computation {#choose-marker-computation-classes}
...
### Groups Defined by Categorical Metadata {#categorical-metadata-groups}
...
### Groups Defined by Feature Expression {#feature-expression-groups}
...
## Other DGE Settings {#other-differential-expression-settings}

### Positive Markers Only {#positive-markers-only}
...
## Interpreting DGE Results {#interpreting-differential-expression-results}
...
### DGE DimPlot {#differential-expression-DimPlot}
...
## Running a correlation analysis (#run-correlation-analysis)
...
## Interpreting Correlation Results {#interpret-correlation-results}
...
### Correlation table {#correslation-table}
...
### Correlation Scatterplots {#correlation-scatterplots}
...
# Changing Datasets {#changing-datasets}

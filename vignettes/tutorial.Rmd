...
This tutorial will guide you through the use of scExploreR to analyze your data. This is not a comprehensive exploration of each feature: for more information on any feature, see the [full documentation](full_documentation.html). The browser used for this tutorial is hosted [here]().
...
![](tutorial-001_Simple_DGE.gif){style="display: block; margin: 10px auto;" width="639"}
...
![](tutorial-002_Results_Summary.png){.centered-image width="633"}
...
The correlations tab can be used, among other things, to determine which genes are co-expressed with a given gene in a sample. From the previous example, we will analyze the correlation of other genes with CXCR4, a top marker from the previous example.

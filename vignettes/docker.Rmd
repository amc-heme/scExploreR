...
The ```config.yaml``` file specifies datasets and settings for scExploreR.
```config.yaml
# config.yaml
...
For detailed instructions on configuring datasets, refer to the scExploreR Dataset Setup Walkthrough.

...
Numeric metadata can't be used to group or split plots, but it can be used for subsetting and may be plotted like features if enabled via the "Include numeric metadata" option in the config app. See the config app section for instructions on how to enable/disable this usage.
:::

...
.card-header{
  ...
  /* Adds a margin-top of 0 to the existing bootstrap class to remove white space
...
.callout {
  ...
  /* If the border-radius is greater than border-left-width,  
     ...
     creating a crescent-like shape*/
...
Settings for the assays to be included in the browser are entered in the assays tab. <!--This is the first place you mention a new object being made, and that it's a Seurat object? That was confusing, so here's a suggested language change -->
...
The assay selected in this tab will be the assay used when computing differential expression or correlation; it does not affect plotting.

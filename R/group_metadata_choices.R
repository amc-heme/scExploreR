#' group_metatata_choices 
#' 
#' Takes a list of choices for a metadata category and sorts the choices
#' into groups using the group selections defined in the config file.
#'
#' @param group_info  a list giving the information for each group. This should 
#' be accessed from the config file using `config$metadata$<category_name>$groups`.
#' @param choices a vector of choices for the metadata category to be sorted 
#' into groups 
#'
#' @noRd

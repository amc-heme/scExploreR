### Manual_dim_UI ###
# Creates two slider-text box pairs for manual control of the height and width 
# of a plot.
manual_dim_UI <- function(plot_type,
                          ...
                          max_height=2000,
                          min_height=200){
  # Plot_dimension_input: used within manual_dim_UI. Creates a slider and text 
  # box intended to input either the width or height of a plot when manual 
  ...
  # Create checkbox: if checked, manual dimensions for the plot will be used 
  ...
  div(
    ...
    conditionalPanel(
      condition = manual_dimensions_desired,
      # Slider/text box for specifying width
      plot_dimension_input(
        slider_input_id = width_slider_id,
      ...
      plot_dimension_input(
        slider_input_id = height_slider_id,

...
# Full Metadata For object

Below is an extended summary of the metadata in the current object, which includes metadata variables in the object that were hidden by the user setting up this instance of the app. This document is most useful as a guide for the advanced subsetting feature. The ID of the category is shown in bold, and the data class (according to R) is shown beneath the ID.

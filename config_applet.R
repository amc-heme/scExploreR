...
# main server function. A module created within a module, which is itself 
# created within the main server has a level of 2.
...
metadata_tab <- function(){
  sidebarLayout(
    ...
    applet_main_panel(
      ...
      # the corresponding column. The "id" argument in lapply is the name 
...
server <- function(input, output, session) {
  ...
  # 1.2. Create module server instances for each possible assay
